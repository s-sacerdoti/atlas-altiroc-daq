...
create_generated_clock -name clk100 [get_pins {U_Core/GEN_ETH.U_ETH/U_MMCM/MmcmGen.U_Mmcm/CLKOUT0}] 
...
set_clock_groups -asynchronous -group [get_clocks {clk156}] -group [get_clocks {clk100}]
