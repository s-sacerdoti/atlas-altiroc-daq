...
# Place/Route as 166 MHz to provide more timing margin (safety factor)
create_clock -name localRefClk -period 6.000 [get_ports { localRefClkP }]
create_clock -name clk160MHz   -period 6.000 [get_ports { pllClkInP[0] }]
