...
def fixedTOAhistogram(top,argip,
    ...
    top.Fpga[0].Asic.Gpio.DlyCalPulseReset.set(DelayValue) # Falling edge of EXT_TRIG
                                                           ##
    try:                                                   ##
        os.remove('/home/hgtd-lal/Documents/ALTIROC1/IrradMeasurements/TestData/TestData/TOA%d.dat' %DelayValue)                 ##
    except OSError:                                        ##
        pass                                               ##
    top.dataWriter._writer.open('/home/hgtd-lal/Documents/ALTIROC1/IrradMeasurements/TestData/TOA%d.dat' %DelayValue)   ##
