def getDACList(board):
    ...
    if board==2:
        ...
        # dacList[(0,0)]=330#B13,4,1.000000 
        # dacList[(1,0)]=310#B13,4,0.970000 
        # dacList[(2,0)]=330#B13,4,1.000000 
        # dacList[(3,0)]=320#B13,4,0.980000 
        # dacList[(4,0)]=300#B13,4,0.990000 
        # dacList[(5,0)]=390#B13,4,1.000000
        # #dacList[(6,0)]=TOO noisy?
        # dacList[(7,0)]=310#B13,4,0.990000 
        # dacList[(8,0)]=340#B13,4,1.000000 
        # dacList[(9,0)]=320#B13,4,0.980000         
        # dacList[(10,0)]=320#B13,4,1.000000 
        # dacList[(11,0)]=345#B13,4,0.970000 
        # dacList[(12,0)]=365#B13,4,0.990000 
        # dacList[(13,0)]=350#B13,4,0.990000 
        # dacList[(14,0)]=340#Q=5
